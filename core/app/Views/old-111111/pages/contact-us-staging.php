						...
						<div class="col-lg-8">
							...
							<div class="row">
    							...
    							<!--<div class="col-md-12 col-sm-12">
    							    <h2 class="uppercase bottommargin-xs topmargin-sm">OMNI UNITED</h2>
    						    </div>-->
								...
								<div class="col-md-6 col-sm-12">
									...
									<div class="adress-bar">
										...
										<!--<p class="main-add"><b>Omni United (S) Pte Ltd</b><br>
											1 Raffles Place<br>
											#30-03 One Raffles Place<br>
										Singapore - 048616</p>-->
										<p class="main-add">
										    <b>Omni United (S) Pte Ltd</b>
    										<br>2 Central Boulevard, 
    										<br>#08-04A West Tower, 
    										<br>101 Central Boulevard,
    										<br>Singapore 018916
										</p>
										<div class="cont-bar">
											T: +65 6423 1431
								...
								<div class="col-md-6 col-sm-12">
    							    <h2 class="uppercase bottommargin-xs topmargin-sm">OMNISOURCE</h2>
								    <div class="adress-bar">
										...
										<!--<div class="cont-bar">
											Toll-Free: 800-725-1482
										</div>
										<div class="open-status">
											Business Hrs: 0900 – 1800 (UTC-5)<br>
											Monday - Friday
										</div>-->
										<div class="cont-bar">
											<!--T: (214)-630-1482-->
										...
										<div class="open-status">
											Business Hrs: 0900 – 1800<br>
											Monday - Friday
										</div>
									</div>
									<!--<div class="adress-bar">
										<div class="adreess-name">UNITED STATES</div>
										<p class="main-add"><b>Omni United USA, Inc</b><br>
    										3750 S. Watson Rd.,<br>
                                            Suite 100,<br>
                                            Arlington, TX 76014</p>
										<div class="cont-bar">
											T: 800-725-1482 (Toll Free)
										</div>
										<div class="open-status">Business Hrs: 0900 – 1800 (UTC-5)<br>
										Monday – Friday</div>
									</div>-->
								</div>
								
							</div> <!--.row.border-sec end-->
							...
							<!--<div class="row border-sec">
								...
								<!--<div class="col-md-6 col-sm-12">
									<div class="adress-bar nobottommargin">
										<div class="adreess-name">UNITED ARAB EMIRATES</div>
										<p class="main-add"><b>Omni MEA Tyres LLC</b><br>
											#507A City Tower 2<br>
										...
										<div class="open-status">
											Business Hrs: 0900 – 1800 (UTC+4)<br>
											Sunday – Thursday
										</div>
									</div>
								</div>-->
