...
<style>
	...
	@media screen and (max-width: 767px) {
	.custom-heading-block h2{line-height: 38px !important;}
	}
...
<section id="content">
	...
	<div class="content-wrap">
	    ...
	    <section class="whitebg bottommargin">
			...
			<div class="fillter-bar ptlg">
				<div class="container clearfix">
					...
					<div class="heading-block center subheading" style="margin-bottom: 0 !important;margin-top: 1.5rem;">
    				<a href="<?= base_url('buy-radar-tires') ?>" class="red"><h3 class="red" style="color:#DA2224">CLICK HERE TO BUY RADAR TIRES ONLINE</h3></a>
				</div>
		...
		<section class="topmargin nobottommargin  bg-gray buyonlinesection ">
			<div class="container clearfix">
				<!--<div class="heading-block  center custom-heading-block">
