			...
			<div class="divcenter topmargin bottommargin" style="max-width: 700px;">
				...
				<div class="card nobottommargin">
					<div class="card-body" style="padding: 40px;">
						...
						<?= form_open('admin/icons/update/'.$icon['icon_id'],['id'=>'icons_form'], ['id'=>$icon['icon_id']]) ?>

							<div class="col_full">
								<label for="title">Title*:</label>
								<input type="title" class="form-control" id="title" name="title" placeholder="Enter title" value="<?= $icon['icon_title']; ?>">
							...
							<div class="col_full">
								...
								<input type="class" class="form-control" id="class" name="class" placeholder="Enter class" value="<?= $icon['icon_class']; ?>">
								<!-- <small class="help-block">A valid email address</small> -->
							</div>
							...
							<div class="col_full ">
								...
								<input type="checkbox" id="status" name="status" class="" <?= $icon['icon_status'] ? 'checked' : '' ;?> >
