			...
			<div class="divcenter topmargin bottommargin" style="max-width: 700px;">
				...
				<div class="card nobottommargin">
					<div class="card-body" style="padding: 40px;">
						...
						<?= form_open('admin/race/edit/'.$record['id'], [], ['post_type'=>'race'] ) ?>
							<div class="col_full">
							...
							<div class="col_full">
								...
								<input type="text" class="form-control" id="category" name="category" placeholder="Enter category" value="<?=  set_value('category')?set_value('category'):isset($post['category'])?$post['category']:"" ; ?>">
							</div>
