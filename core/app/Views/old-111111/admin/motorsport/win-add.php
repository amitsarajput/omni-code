			...
			<div class="divcenter topmargin bottommargin" style="max-width: 700px;">
				...
				<div class="card nobottommargin">
					<div class="card-body" style="padding: 40px;">
						...
						<?= form_open('admin/win/add', [], ['post_type'=>'win'] ) ?>
							<div class="col_full">
							...
							<div class="col_full">
								...
								<input type="text" class="form-control driver" id="driver" name="driver" placeholder="Enter driver" value="<?= set_value('driver'); ?>">
							</div>
							...
							<div class="col_half col_last">
								...
								<input type="text" class="form-control date_picker date" id="date" name="date" placeholder="Enter Date" value="<?= set_value('date'); ?>">
							</div>
