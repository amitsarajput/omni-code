			...
			<div class="divcenter topmargin bottommargin" style="max-width: 700px;">
				...
				<div class="card nobottommargin">
					<div class="card-body" style="padding: 40px;">	
						...
						<?= form_open('admin/dealers/add'); ?>
							<div class="col_full">
								<label for="title">Dealer*:</label>
								<input type="text" class="form-control" id="dealer" name="dealer" placeholder="Dealer" value="<?= set_value('dealer'); ?>">
							</div>

							<div class="col_full">
								<label for="title">Title*:</label>
								<input type="title" class="form-control" id="title" name="title" placeholder="Title" value="<?= set_value('title'); ?>">
							</div>
							...
							<div class="col_one_fourth">
								...
								<input type="text" class="form-control" id="country" name="country" placeholder="Country" value="<?= set_value('country'); ?>">
							</div>

							<div class="col_one_fourth col_last">
								<label for="sub_title">Country Code:</label>
								<input type="text" class="form-control" id="country_code" name="country_code" placeholder="Country Code" value="<?= set_value('country_code'); ?>">
							</div>
							...
							<div class="col_half">
								...
								<input type="text" class="form-control" id="postal" name="postal" placeholder="Postal" value="<?= set_value('postal'); ?>">
							</div>
							...
							<div class="col_half">
								...
								<input type="text" class="form-control" id="lat" name="lat" placeholder="Enter Lat" value="<?= set_value('lat'); ?>">
							</div>

							<div class="col_half col_last">
								<label for="sub_title">Lng:</label>
								<input type="text" class="form-control" id="lng" name="lng" placeholder="Enter Lng" value="<?= set_value('lng'); ?>">
							</div>

							<div class="col_full">
								<label for="sub_title">Direction:</label>
								<input type="text" class="form-control" id="direction" name="direction" placeholder="Enter Direction" value="<?= set_value('direction'); ?>">
							</div>
