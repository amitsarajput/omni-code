			...
			<div class="divcenter topmargin bottommargin" style="max-width: 700px;">
				...
				<div class="card nobottommargin">
					<div class="card-body" style="padding: 40px;">
						...
						<?= form_open('admin/tire-category/update/'.$tyre_category['tc_id'],['id'=>'tire-category_form'], ['id'=>$tyre_category['tc_id']]) ?>
							<div class="col_full">
								<label for="title">Brand*:</label>
								<input type="title" class="form-control" id="title" name="title" placeholder="Enter title" value="<?= $tyre_category['tc_title']; ?>">
							...
							<div class="col_full ">
								...
								<input type="checkbox" id="status" name="status" class="" <?= $tyre_category['tc_status'] ? 'checked' : '' ;?> >
