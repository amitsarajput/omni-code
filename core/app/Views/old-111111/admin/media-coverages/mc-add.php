			...
			<div class="divcenter topmargin bottommargin" style="max-width: 700px;">
				...
				<div class="card nobottommargin">
					<div class="card-body" style="padding: 40px;">	
						...
						<?= form_open('admin/mc/add',['id'=>'form']); ?>
							...
							<div class="col_half">
								...
								<input type="text" class="form-control" id="media_house" name="media_house" placeholder="Media House" value="<?= set_value('media_house'); ?>">
							</div>
							<div class="col_half col_last">
								<label for="hyperlink">Link*:</label>
								<input type="text" class="form-control" id="hyperlink" name="hyperlink" placeholder="Enter Hyperlink" value="<?= set_value('hyperlink'); ?>">
							</div>
							...
							<div class="col_half">
								...
								if ($cs) {
									...
									echo form_dropdown('category', $c_options, set_value('category') ,["id"=>"category", "class"=>"form-control"]);
								}
								?>
