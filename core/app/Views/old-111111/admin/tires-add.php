			...
			<div class="divcenter topmargin bottommargin" style="max-width: 800px;">
				...
				<div class="card nobottommargin">
					<div class="card-body" style="padding: 40px;">
						...
						<?= form_open('admin/tire/save',['id'=>'form_tire_add']) ?>						
							...
							<div class="col_full ">
								...
								if ($countries) {
									...
									echo form_dropdown('country', $country_options, set_value('country'),["id"=>"country", "class"=>"form-control"]);
								}
								?>
							...
							<div class="col_one_third">
								...
								<input type="text" class="form-control slug" id="slug" name="slug" placeholder="Enter slug" value="<?= set_value('slug'); ?>">
							...
							<div class="col_one_third">
								...
								if ($tyre_categories) { 
									$tc_options=array();
									foreach ($tyre_categories as $tc) {
									 	$tc_options[$tc['tc_id']]=$tc['tc_title'];
									}
									echo form_dropdown('category', $tc_options, set_value('category'),["id"=>"category", "class"=>"form-control"]);
								} 
								?>
							</div>
							...
							<div class="col_one_third col_last">
								...
								<?php
									...
									echo form_dropdown('terrain_category', $trnc_options, set_value('terrain_category'),["id"=>"terrain_category", "class"=>"form-control"]);								 
								?>
							</div>
							...
							<div class="col_half">
								...
								?>
								<?= form_multiselect('vehicle_type[]', $vtoptions , set_value('vehicle_type') , array("id"=>"vehicle_type",'class'=> 'form-control') );?>
							...
							<div class="col_half col_last icons-selector-wrapper">
								<?php 
								if ($icons):
									$options= array();
								...
								<?php  if ($icons) { ?>
									<?= form_multiselect('icons[]', $options , set_value('icons') , array("id"=>"icons",'class'=> 'form-control icons-selector') );?>
								<?php } ?>
							...
							<div class="col_full ">
								...
								<input type="checkbox" id="status" name="premium_tyre" class="" >
