...
<style>
    ...
    h4.custom-heading-block2  {font-size: 24px; line-height: 1.5 !important; font-family: 'Saira Semi Condensed', sans-serif !important; color: #fff; position: relative;margin-bottom: 20px !important;}
    ...
    #section-legend .legend {display: flex; margin-left: 17%; margin-right: 12%;}
	...
	<div class="slider-inner">
		...
		<div class="container text-center">
			<div class="row">
				<div class="emphasis-title nobottommargin mx-auto">
					...
					<div><a href="#"  data-scrollto="#video-reviews" data-easing='easeOutQuad' data-speed="750" data-offset="70" class="video-reviews-link" >Watch Video Reviews</a></div>
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div id="section-intro" class="section center notopmargin nobottommargin pt-lg pb-lg">
					<div class="container clearfix">
						<div class="heading-block  center custom-heading-block2">
							<h2 class="font-weight-bold">RENEGADE-X staging</h2>
						</div>
						<div class="row">
							<div class="col-lg-12">
								<p class="justifycenter">The Renegade-X is the all new and top-of-the-line extreme terrain tire range from Radar Tires. This innovative "stealth" inspired tire is born out of the partnership between Radar Tires and leading Italian automotive design house GFG Style. This feature-packed range is designed and engineered for drivers that need extreme off-road performance on mud, rocks, gravel and sand while offering durability and an aggressive aesthetic that enthusiasts crave.</p>
								<p class="justifycenter">Rim Flange protector on all sizes</p>
								<h4 class="custom-heading-block2">WARRANTY</h4>
								<p class="justifycenter">30-Day Satisfaction Guarantee<br>
                                    <a target="_blank" class="red-link" href="https://www.omni-united.com/radar-us/limited-warranty">View Details</a></p>
							</div>
						</div>
					...
					<div class="container clearfix">
						...
						<div class="row clearfix renegade-x-features" style="justify-content: center;">
							<div class="col-lg-4 topmargin-sm">
								...
								<p>High void-to-lug ratio, deep side blocks and a specially formulated Rock-Crawl tread compound provides exceptional traction and grip on rocks, gravel, mud and soft soil. Mud-rescue shoulder provides additional traction that helps pull the vehicle out of mud.</p>
							...
							<div class="col-lg-4 topmargin-sm">
								...
								<p>Optimized tread pattern design reduces noise for a quieter and more comfortable on-road ride.</p>
                ...
                <!--Video Reviews-->
                <div id="video-reviews" class="section center notopmargin nobottommargin nobottompadding pt-lg pb-lg">
                    <div class="container clearfix">
						<div class="heading-block  center custom-heading-block2">
							<h2 class="font-weight-bold">VIDEO REVIEWS</h2>
						</div>
                        <div class="row">
                            <div class="vid-reviews"  data-lightbox="gallery">
                                    <a class="vid-review lozad-background mfp-iframe" href="https://www.youtube.com/watch?v=yszouiZHCEc" data-lightbox="gallery-item"  data-background-image="<?= base_url('uploads/video-reviews-posters/us-renegade-x-1.webp');?>"></a>
                                    <a class="vid-review lozad-background mfp-iframe" href="https://www.youtube.com/watch?v=Be-rFBIr3bU" data-lightbox="gallery-item"  data-background-image="<?= base_url('uploads/video-reviews-posters/us-renegade-x-2.webp');?>"></a>
                                    <a class="vid-review lozad-background mfp-iframe" href="https://www.youtube.com/watch?v=U2bJNLb2p4U" data-lightbox="gallery-item"  data-background-image="<?= base_url('uploads/video-reviews-posters/us-renegade-x-3.webp');?>"></a>
                                    <a class="vid-review lozad-background mfp-iframe" href="https://www.youtube.com/watch?v=ytPJeEegkB0" data-lightbox="gallery-item"  data-background-image="<?= base_url('uploads/video-reviews-posters/us-renegade-x-4.webp');?>"></a>
                                    <a class="vid-review lozad-background mfp-iframe" href="https://www.youtube.com/watch?v=O1xKoJd4nSk" data-lightbox="gallery-item"  data-background-image="<?= base_url('uploads/video-reviews-posters/us-renegade-x-5.webp');?>"></a>
                                    <a class="vid-review lozad-background mfp-iframe" href="https://www.youtube.com/watch?v=7YkFNWcaQjc" data-lightbox="gallery-item"  data-background-image="<?= base_url('uploads/video-reviews-posters/us-renegade-x-6.webp');?>"></a>
                            </div>
                        </div>
                    </div>
                ...
                <section id="reviews" class="full-section section-dark clearfix">
                    <div class="container clearfix">
                        <div class="row">
									...
									<div class="tab-content" id="size-all">
										<div class="table-responsive">
											<table border="0" cellpadding="0" cellspacing="0" class="table">
                                              ...
                                              <tbody>
                                                    <tr>
                                                        <td width="184">37x13.50R24LT</td>
                                                        <td width="90">124Q</td>
                                                        <td width="90">F</td>
                                                        <td width="126"><i class="icon-ok"></i></td>
                                                        <td width="116">9.5-(11.0)-12.0</td>
                                                        <td width="106">36.9</td>
                                                        <td width="94">13.6</td>
                                                        <td width="126">21.0</td>
                                                    </tr>
									...
									<div class="tab-content" id="size-22">
										<div class="table-responsive">
											<table border="0" cellpadding="0" cellspacing="0" class="table">
                                              <thead>
                                                <tr>
                                                  <th width="184">Size</th>
                                                  <th width="90">L.I./S.R.</th>
                                                  <th width="90">L.R.</th>
                                                  <th width="126">Rim<br>Protector</th>
                                                  <th width="116">Approved Rim<br>
                                                  Width Range(in.)</th>
                                                  <th width="106" align="left">Overall<br>
                                                  Diameter(in.)</th>
                                                  <th width="94" align="left">Section<br>
                                                  Width(in.)</th>
                                                  <th width="126" align="left">Tread<br>
                                                  Depth(1/32nds)</th>
                                                </tr>
                                              </thead>
                                              <tbody>
...
<script>
  ...
  testFreaks.push(["setProductId", "us-renegade-x"]);
