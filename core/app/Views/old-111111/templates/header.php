...
.product-single.radar-tires #slider-flex.flexslider:after,
.product-single.radar-tires #slider-flex2.flexslider:after{
    display:none;
}
			...
			<div id="header-wrap">
				<div class="container clearfix">
					...
					<div id="logo" class="custom-logo">
						<a href="<?= base_url() ?>" class="standard-logo main-logo"><img src="<?= base_url('assets/img/main-logo.png');?>"  alt="Omni"></a>
						<a href="<?= base_url() ?>" class="retina-logo" data-dark-logo="<?= base_url('assets/img/main-logo.png');?>"><img src="<?= base_url('assets/img/main-logo.png');?>" alt="Omni"></a>
					</div><!-- #logo end -->
