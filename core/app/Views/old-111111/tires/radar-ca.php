	...
	<div class="slider-parallax-inner">
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
			    ...
			    <div class="swiper-slide  dark lozad-background" data-background-image="<?= base_url('assets/img/radar-ca-banner--premium-collection-1.webp') ?>">
			    ...
			    <a href="<?= base_url('radar-ca/ca-renegade-at-sport'); ?>" class="swiper-slide  dark lozad-background" data-background-image="<?= base_url('assets/img/radar-ca-banner--renegade-at-sport-1.webp') ?>">
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
							<h2>&nbsp;</h2>
							<p class="">&nbsp;</p>
		...
		<section id="full-width" class="full-section  ptlg pblg graycolor text-justify">
			<div class="container clearfix">
				<div class="row">
					...
					<div class="col-lg-6">
					    <p>Being one of the most reliable brands in the market, Radar Tires are manufactured in compliance with the highest regulatory certifications and utilize PAH-free oils in their compounds to comply with stringent European standards. In addition to this, the brand has always been committed to being socially responsible by supporting the Breast Cancer Research Foundation (BCRF) since 2011 and to date has donated close to $1.4 million, funding close to 28,000 hours of critical life-saving research.</p>
