...
<section id="content">
  ...
  <div class="content-wrap product-single test-tire">
              ...
              <div class="flexslider" id="slider-flex2">
                <div class="slider-wrap">
                  <?php foreach ($images as $image) { ?>
                      <div class="slide"><img src="<?= base_url('uploads/tire_images/other/'.$image);?>" alt="<?= $tyres['title']; ?>"></div>
                  <?php } ?>
                </div>
              </div>
            </div>
          ...
          <div id="oc-posts" class="owl-carousel posts-carousel carousel-widget"  data-autoplay="3000" data-margin="0" data-nav="true" data-loop="true" data-pagi="true" data-items="1" data-items-xs="1" data-items-sm="1" data-items-md="1" data-items-lg="1" >
            ...
            <div class="oc-item">
              <div class="ipost clearfix">
                ...
                <div class="products-image" style="background-image:url('<?= base_url('uploads/features/'.$feature['image']);?>')" ><!--<img src="<?= base_url('uploads/features/'.$feature['image']);?>" alt="">--></div>
              </div>
            </div>
            <?php } ?>
          </div>
                        ...
                        <?php foreach($sized as $key=>$sizes){ ?>
                          ...
                          <tr>
                            ...
                            <?php if ($extra_cols_on==true): ?>
                              ...
                              <?php endif; ?>
                              <?php if (in_array('mark', $extra_cols)): ?>
                               <td style="line-height:17px;"><?= $size["mark"]; ?></td>
                              <?php endif; ?>
                              <?php if (in_array('eulabel', $extra_cols)): ?>
                          ...
                          <tr id="eulabel-eulabeldetails-<?= $size["rim"]; ?>" class="eulabeldetails">
                            <td colspan="4">
                              <?php if($size["eulabel"] !== null):?>
                              <div class="eulabeldetails-wrapper">
                                <?php $eulabel=json_decode($size["eulabel"], true); ?>
                                <div class="eulabel-image">
                                  <img src="<?= base_url('uploads/eu-labels/'.$eulabel['label_image']) ?>" alt="">
                                </div>
                                <?php $eulabelcontent=$eulabel['label_content']; ?>
                                <div class="eulabel-details-content">
                                  <h4 class="eulabel-title bottommargin-xs"><?= $eulabelcontent['title']?></h4>
                                  <div class="eulabel-body">
                                    <?= $eulabelcontent['body']?>
                                  </div>
                                </div>
                              </div>
...
<style>
  ...
  @media only screen and (max-width: 1024px) {
    .eulabeldetails-wrapper .eulabel-image img{max-width: 300px;border: 2px solid #034da2;margin: 5px;}
