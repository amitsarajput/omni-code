					...
					<div class="footer-custom-col">
						<ul class="ul-custom">
							...
							<li>
								...
								<a href="<?= base_url('radar-us');?>" class="radar_link" >Radar</a>
								...
								<a href="<?= base_url('north-america-dealer-locator');?>">Dealer Locator - North America</a>
								<a href="<?= base_url('uk-europe-dealer-locator');?>">Dealer Locator - UK/Europe</a>
