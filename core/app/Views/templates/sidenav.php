			...
			<div class="widget clearfix">
				...
				<nav class="nav-tree nobottommargin">
					...
					<li class="<?= $menu==2 ? 'active' : ''; ?>"><a href="#">Our Brands</a>
						<ul>
							<li class="<?= $menu==2 && $submenu==1 ? 'active' : ''; ?>"><a href="<?= base_url('radar-ca');?>" class="radar_link">Radar</a></li>
					...
					<li class="<?= $menu==7 ? 'active' : ''; ?>"><a href="#">Warranty</a>
						<ul>
							<li class="<?= $menu==7 && $submenu==1 ? 'active' : ''; ?>"><a href="https://radartires.com/us/warranty">Radar - North America</a></li>
