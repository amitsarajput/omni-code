<!-- Page Title
============================================= -->
<!--<section id="page-title" class="page-title-dark page-title-right skrollable skrollable-between" style="padding: 300px 0;  background-size: cover!important; background-position: center center;" data-bottom-top="background-position:0px 440px;" data-top-bottom="background-position:0px -500px;">

    <div class="mx-auto vid-parent" >
		<div class="video-wrap ">
		    <video id="" poster="<?= base_url("assets/img/landing-pages/9/slides/OMNI -Landing-Page-Hero-1.webp")?>" preload="auto" autoplay="true" muted="true" loop >
			    <source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.mp4")?>' type='video/mp4' />
			    <source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.webm")?>' type='video/webm' />
...
<!--<video id="player" class="video"  poster="<?= base_url("assets/img/landing-pages/9/slides/OMNI -Landing-Page-Hero-1.webp")?>" preload="none" autoplay muted>
    <source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.mp4")?>' type='video/mp4' />
 <source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.webm")?>' type='video/webm' />
	<source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.ogv")?>' type="video/ogg" />
</video>-->

<section id="slider" class="slider-element swiper_wrapper home-slider main-slider-home full-width clearfix" loop="true" data-speed="650" data-autoplay="7000">
		...
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				<div class="swiper-slide dark" >
				    ...
				    <div class="mx-auto vid-parent" >
    					<div class="video-wrap ">
        				    <video id="" poster="<?= base_url("assets/img/landing-pages/9/slides/OMNI -Landing-Page-Hero-1.webp")?>" preload="auto" autoplay muted loop  >
        					    <source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.mp4")?>' type='video/mp4' />
        					    <source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.webm")?>' type='video/webm' />
        					<!--		<source src='<?= base_url("assets/img/landing-pages/9/videos/radartire-video-1.ogv")?>' type="video/ogg" />-->
        					</video>
			...
			<!--video-wrap <div class="slider-arrow-left"><i class="icon-angle-left"></i></div>
                    ...
                    <div class="text-content">
                        <div class="section-title text-center">
                            ...
                            <div class="section-title--text">
                                <p>The Radar Premium Collection has been designed and engineered to rival leading established brands in safety, handling, durability, noise and more. This makes our products perform just like any other premium brand, thus rightfully earning the tag of "Premium" but without the hefty price that established brands often charge.</p>
                                <p>Say goodbye to paying a premium for a name and discover the unbeatable value of the Radar Premium Collection.</p>
            ...
            <div class="row flex-columns">
                <div class="flex-col text">
                    <div class="section-title">
                        ...
                        <a href="<?= base_url("radar-us")?>" class="red-button--full">Click here</a>
                        </div>
    ...
    <div id="fitting-seciton" class="section-two-col">
        <div class="container">
            <div class="flex-columns">
                ...
                <div class="flex-col image"><img src='<?= base_url("assets/img/landing-pages/9/FittingEveryDriver_Tire.webp")?>' /></div>
            </div>
        </div>
    </div>
