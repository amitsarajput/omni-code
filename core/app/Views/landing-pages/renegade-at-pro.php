...
<style>
    ...
    #section-intro {background-image: url(<?= base_url('assets/img/rattle-snake.png');?>); background-repeat:no-repeat; background-position: left 60px; background-size: 350px;}
    ...
    #section-sizes{
        background-image: url(https://www.omni-united.com/assets/img/rattle-snake.png);
    ...
    #section-legend .legend .box:nth-child(1) {width: 18%; padding-left: 0; }
    #section-legend .legend .box:nth-child(2) {width: 43%; }
    #section-legend .legend .box:nth-child(3) {width: 39%; border-right: none; }
	...
	#section-features {background-image: url(<?= base_url('assets/img/rattle-snake-opp.png');?>); background-repeat:no-repeat; background-position: right 60px; background-size: 350px;}
	#section-features:before {content:""; background-image: url(<?= base_url('assets/img/rattle-snake.png');?>); background-repeat:no-repeat; background-position: left 60px; background-size: 350px;}
	...
	.bgimg-left {background-image: url(https://www.omni-united.com/assets/img/rattle-snake.png) !important; background-repeat: no-repeat !important; background-position: left 60px !important; background-size: 350px !important;}
	.bgimg-right {background-image: url(https://www.omni-united.com/assets/img/rattle-snake-opp.png) !important; background-repeat: no-repeat !important; background-position: right 60px !important; background-size: 350px !important;}
    .image-rotator:after{
      content: "";
		...
		<div class="container text-center">
			<div class="row">
				<div class="emphasis-title nobottommargin mx-auto">
					<img src="<?= base_url('assets/img/renegade-at-pro.png');?>">
					<h1 class="font-weight-bold ls1" style="font-size:44px !important;">Made for <br class="show-xs">All Terrains</h1>
				</div>
				<div class="col-sm-12">
    				...
    				<div id="video" class="video-sec">
    				    ...
    				    <video poster="<?= base_url('assets/img/renegade-at-pro/video/ATProIntroPosterNew.webp');?>" controls controlsList="nodownload"  preload="none" style="display: block; width: 100%;">
							<source src='<?= base_url('assets/img/renegade-at-pro/video/RenegadeATPro.webm');?>' type='video/webm' />
							<source src='<?= base_url('assets/img/renegade-at-pro/video/RenegadeATPro.mp4');?>' type='video/mp4' />
						</video>
    				</div>
				</div>
			</div>
				...
				<div id="section-intro" class="section center notopmargin nobottommargin pt-lg pb">
					<div class="container clearfix">
						<div class="heading-block  center custom-heading-block2">
							<h2 class="font-weight-bold">RENEGADE A/T PRO</h2>
						</div>
						<div class="row">
							<div class="col-lg-12">
								<p class="justifycenter">The Renegade A/T Pro is the brand new all-terrain range from Radar Tires that is engineered for drivers that need exceptional off-road performance while giving a quiet, smooth on-road ride. This range offers a combination of increased off-road grip and handling with excellent traction. The tires also utilize a special silica based tread compound that offers outstanding cut and chip resistance along with the all-new innovative “M-sipe”, designed for Maximum grip in all conditions. Each tire features a Rattlesnake inspired dual sidewall design which allows you to customize the look of your vehicle. The “fang” side features a snake head design and fangs for added traction and the “rattle” side features a snake tail design for added protection.</p>
							</div>
						</div>
						<div class="renegade-x-icons">
							...
							<div>
								<img src="<?= base_url('assets/img/icons/ALL-TERRAIN-2.jpg');?>">
								<h4>ALL TERRAIN</h4>
							</div>
							<div>
						...
						<div class="row clearfix">
							<div class="col-lg-10 offset-lg-1 col-md-10 offset-md-1 col-sm-12">
							    <div id="slider" class="slider-element tire-carousel" style="">
                        			...
                        			<div id="oc-slider" class="owl-carousel carousel-widget custom-js" data-margin="0" data-items="1" data-pagi="false" data-loop="true" data-animate-in="" data-speed="200" data-animate-out="">
                                				<a href="<?= base_url('assets/img/renegade-at-pro/slides/preview-1.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-pro/slides/preview-1.webp');?>" alt="Renegade A/T Pro"></a>
                                				<a href="<?= base_url('assets/img/renegade-at-pro/slides/preview-2.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-pro/slides/preview-2.webp');?>" alt="Renegade A/T Pro"></a>
                                				<!--<a href="<?= base_url('assets/img/renegade-at-pro/slides/preview-3.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-pro/slides/preview-3.webp');?>" alt="Renegade A/T Pro"></a>-->
                                				<a href="<?= base_url('assets/img/renegade-at-pro/slides/preview-4.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-pro/slides/preview-4.webp');?>" alt="Renegade A/T Pro"></a>
                                				<!--<a href="<?= base_url('assets/img/renegade-at-pro/slides/preview-5.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-pro/slides/preview-5.webp');?>" alt="Renegade A/T Pro"></a>-->
				...
				<div id="section-features" class="section center notopmargin nobottommargin pt-lg pb-0">
					<div class="container clearfix">
						...
						<div class="row clearfix renegade-x-features">
							<div class="col-lg-12">
								<h4 class="font-weight-bold">RATTLESNAKE EDITION</h4>
								<p>Dual sidewall design featuring a Fang side with a snake head design for added traction and a Rattle side for added protection </p>
								<img src="<?= base_url('assets/img/renegade-at-pro/FB/fb-1.png');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">INCREASED STABILITY <br>AND HANDLING</h4>
								<p>Wide center block design ensures no pattern movement on-road and a smooth, quiet ride and even wear</p>
								<img src="<?= base_url('assets/img/renegade-at-pro/FB/fb-2.png');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">EXCEPTIONAL ALL TERRAIN TRACTION <br>AND STABILITY</h4>
								<p>Optimized interlocking tread block design ensures the pattern works in harmony with the terrain</p>
								<img src="<?= base_url('assets/img/renegade-at-pro/FB/fb-3.png');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">OUTSTANDING CUT <br>AND CHIP RESISTANCE</h4>
								<p>Special silica based compound that provides cut and chip resistance and grip in all conditions</p>
								<img src="<?= base_url('assets/img/renegade-at-pro/FB/fb-4.png');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">REDUCED DRILLING AND LODGING OF STONES IN THE TREAD</h4>
								<p>Innovative stone-ejector-technology</p>
								<img src="<?= base_url('assets/img/renegade-at-pro/FB/fb-5.png');?>">
							</div>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<ul>
										...
										<li>&bull; 50,000 Miles Treadwear Limited Warranty</li>
						...
						<div class="row clearfix">
							<div class="col-lg-12">
								<div class="masonry-thumbs grid-container grid-3" data-big="5" data-lightbox="gallery">
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img1.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb1.jpg');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img2.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb2.jpg');?>"></a>
								    <a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img3.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb3.jpg');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img4.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb4.jpg');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img5.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb5.jpg');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img6.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb6.jpg');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img7.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb7.jpg');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img8.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb8.jpg');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-img9.jpg');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-pro/renegade-at-pro-thumb9.jpg');?>"></a>
								</div>
							</div>
						</div>
					</div>
