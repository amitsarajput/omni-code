...
<style>
	...
	.renegade-x-icons > div { border-right: solid 1px #444; padding-right: 15px; padding-left: 15px; margin-bottom: 30px;}
	.renegade-x-icons.four-icons > div {width:25%;}
	.renegade-x-icons.five-icons > div {width:20%;}
		...
		<div class="container text-center">
			<div class="row">
				<div class="emphasis-title nobottommargin mx-auto">
					<img src="<?= base_url('assets/img/renegade-at-5/renegade-at5.webp');?>">
				...
				<div class="col-sm-12">
    				...
    				<div id="video" class="video-sec">
    				    <!--<video id="video-1" poster="<?= base_url('assets/img/renegade-at-5/video/AT5IntroPoster.webp');?>" controls  style="display: block; width: 100%;"></video>-->
    				    <video poster="<?= base_url('assets/img/renegade-at-5/video/AT5IntroPoster.webp');?>" controls controlsList="nodownload"  preload="none" style="display: block; width: 100%;">
							<source src='<?= base_url('assets/img/renegade-at-5/video/Radar-Renegade- AT5.webm');?>' type='video/webm' />
							<source src='<?= base_url('assets/img/renegade-at-5/video/Radar-Renegade- AT5.mp4');?>' type='video/mp4' />
						</video>
    				</div>
				</div>
			</div>
				...
				<div id="section-intro" class="section center notopmargin nobottommargin pt-lg pb">
					<div class="container clearfix">
						<div class="heading-block  center custom-heading-block2">
							<h2 class="font-weight-bold">RENEGADE A/T5</h2>
						</div>
						<div class="row">
							<div class="col-lg-12">
								<p class="justifycenter">The Radar Renegade A/T5 is an exceptional all-terrain tire range that is designed for people who like to venture off-road but need an assured ride on-road aswell. It offers increased stability and resistance to punctures. The A/T5 features the innovative and unique stone-ejector-technology that prevents stones from drilling and lodging in the tread. It has been test proven against the best competitors in the toughest terrains. All sizes have the Three Peak Mountain Snowflake symbol (3PMSF).</p>
							</div>
						</div>
						<div class="renegade-x-icons five-icons">
							<div>
							...
							<div>
								<img src="<?= base_url('assets/img/icons/3PMSF.png');?>">
								<h4>3PMSF</h4>
							</div>
						</div>
					</div>
							...
							<div class="col-lg-10 offset-lg-1 col-md-10 offset-md-1 col-sm-12">
							    <div id="slider" class="slider-element tire-carousel" style="">
                        			...
                        			<div id="oc-slider" class="owl-carousel carousel-widget" data-margin="0" data-items="1" data-pagi="false" data-loop="true" data-animate-in="" data-speed="200" data-animate-out="" >
                        				...
                        				<a href="<?= base_url('assets/img/renegade-at-5/slides/1.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-5/slides/1.webp');?>" alt="Renegade A/T5"></a>
                        				<a href="<?= base_url('assets/img/renegade-at-5/slides/2.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-5/slides/2.webp');?>" alt="Renegade A/T5"></a>
                        				<a href="<?= base_url('assets/img/renegade-at-5/slides/3.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-at-5/slides/3.webp');?>" alt="Renegade A/T5"></a>
					...
					<div class="container clearfix">
						...
						<div class="row clearfix renegade-x-features">
							<div class="col-lg-6">
								...
								<img src="<?= base_url('assets/img/renegade-at-5/fnb/1.webp');?>">
							</div>
							<div class="col-lg-6">
								...
								<img src="<?= base_url('assets/img/renegade-at-5/fnb/2.webp');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">INCREASED STABILITY <br>AND RESISTANCE TO PUNCTURES</h4>
								<p>Robust 3-ply construction reduces the risk of punctures and gives sure-footed handling on all surfaces.</p>
								<img src="<?= base_url('assets/img/renegade-at-5/fnb/3.webp');?>">
							</div>
							<div class="col-lg-6">
								...
								<img src="<?= base_url('assets/img/renegade-at-5/fnb/4.webp');?>">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row clearfix">
							<div class="col-lg-12">
								<div class="masonry-thumbs grid-container grid-3" data-big="5" data-lightbox="gallery">
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-5/gallery/Renegade AT5-1.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-5/gallery/Renegade AT5-1_thumb.webp');?>"></a>
								    <a class="grid-item" href="<?= base_url('assets/img/renegade-at-5/gallery/Renegade AT5-3.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-5/gallery/Renegade AT5-3_thumb.webp');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-at-5/gallery/Renegade AT5-2.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-at-5/gallery/Renegade AT5-2_thumb.webp');?>"></a>
								</div>
							</div>
						</div>
					</div>
            								...
            								<div class="row">
            									<div class="col-12">
            										<ul>
            											...
            											<li><b>OWL</b> = OWL WHITE LETTERS</li>
            										</ul>
            									</div>
            								</div>
            							</div>
