...
<style>
    ...
    #section-intro.starting-section {padding-top:130px;}
    ...
    #section-legend .legend .box:nth-child(1) {width: 50%; padding-left: 0; }
    #section-legend .legend .box:nth-child(2) {width: 25%; }
    #section-legend .legend .box:nth-child(3) {width: 25%; border-right: none; }
	...
	<div class="slider-inner">
		...
		<div class="container text-center">
			<div class="row">
				<div class="emphasis-title nobottommargin mx-auto">
					<img src="<?= base_url('assets/img/renegade-r7/renegade-r7-mt.webp');?>">
					<h1 class="font-weight-bold ls1" style="font-size:44px !important;">Made for <br class="show-xs">All ADVENTURES</h1>
				</div>
				<div class="col-sm-12">
    				<div id="video" class="video-sec">
    				    <video poster="<?= base_url('assets/img/renegade-at-pro/video/ATProIntroPoster.webp');?>" controls controlsList="nodownload"  preload="none" style="display: block; width: 100%;">
							<source src='<?= base_url('assets/img/renegade-at-pro/video/ATProIntro.webm');?>' type='video/webm' />
							<source src='<?= base_url('assets/img/renegade-at-pro/video/ATProIntro.mp4');?>' type='video/mp4' />
						</video>
    				</div>
				</div>
			</div>
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div id="section-intro" class="section starting-section center notopmargin nobottommargin pt-lg pb">
					<div class="container clearfix">
						<!--<div class="heading-block  center custom-heading-block2">
							<h2 class="font-weight-bold">RENEGADE R7 M/T</h2>
						</div>-->
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<p class="justifycenter">The Renegade R7 M/T is a Mud Terrain tire that has been designed specifically for extreme off-road applications. This range fits SUVs, light trucks and is suitable for vehicles with lift-kits. It features a reinforced 3-ply casing for high durability and state-of-the-art Stone-Ejector-Technology which prevents stone retention and subsequent tire damage. An ideal choice for drivers who want no compromise with off-road traction and handling.</p>
							</div>
						</div>
						<div class="renegade-x-icons">
							...
							<div>
								<img src="<?= base_url('assets/img/icons/MUD-TERRAIN.png');?>">
								<h4>MUD TERRAIN</h4>
							</div>
							<div>
							...
							<div class="col-lg-10 offset-lg-1 col-md-10 offset-md-1 col-sm-12">
							    <div id="slider" class="slider-element tire-carousel" style="">
                        			...
                        			<div id="oc-slider" class="owl-carousel carousel-widget" data-margin="0" data-items="1" data-pagi="false" data-loop="true" data-animate-in="" data-speed="200" data-animate-out="" >
                        				...
                        				<a href="<?= base_url('assets/img/renegade-r7/slides/1.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-r7/slides/1.webp');?>" alt="Renegade R7"></a>
                        				<a href="<?= base_url('assets/img/renegade-r7/slides/3.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-r7/slides/3.webp');?>" alt="Renegade R7"></a>
                        				<a href="<?= base_url('assets/img/renegade-r7/slides/2.webp');?>" data-lightbox="image"><img src="<?= base_url('assets/img/renegade-r7/slides/2.webp');?>" alt="Renegade R7"></a>
				...
				<div id="section-features" class="section center notopmargin nobottommargin pt-lg pb-0">
					<div class="container clearfix">
						...
						<div class="row clearfix renegade-x-features">
						    <div class="col-lg-6">
								<h4 class="font-weight-bold">OUTSTANDING TRACTION <br>IN ALL CONDITIONS</h4>
								<p>Aggressive pattern featuring a high void ratio and open shoulder design.</p>
								<img src="<?= base_url('assets/img/renegade-r7/fb/1.webp');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">SUPERIOR OVERALL RESISTANCE TO DAMAGE</h4>
								<p>Reinforced 3-ply casing construction</p>
								<img src="<?= base_url('assets/img/renegade-r7/fb/2.webp');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">ENHANCED TREAD LIFE <br>AND BRAKING ON ALL SURFACES </h4>
								<p>Special tread compound and wide footprint </p>
								<img src="<?= base_url('assets/img/renegade-r7/fb/3.webp');?>">
							</div>
							<div class="col-lg-6">
								<h4 class="font-weight-bold">REDUCED LODGING <br>AND DRILLING OF STONES IN THE TREAD</h4>
								<p>Innovative stone-ejector-technology</p>
								<img src="<?= base_url('assets/img/renegade-r7/fb/4.webp');?>">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row clearfix">
							<div class="col-lg-12">
								<div class="masonry-thumbs grid-container grid-3" data-big="5" data-lightbox="gallery">
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/2770.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/2770_thumb.webp');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/2775.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/2775_thumb.webp');?>"></a>
								    <a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/3634.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/3634_thumb.webp');?>"></a>
								    
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/4369.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/4369_thumb.webp');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/DSC3861R7.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/DSC3861R7_thumb.webp');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/9767.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/9767_thumb.webp');?>"></a>
									
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/DSC3937R7.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/DSC3937R7_thumb.webp');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/R7.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/R7_thumb.webp');?>"></a>
									<a class="grid-item" href="<?= base_url('assets/img/renegade-r7/gallery/ToyotaR7.webp');?>" data-lightbox="gallery-item"><img src="<?= base_url('assets/img/renegade-r7/gallery/ToyotaR7_thumb.webp');?>"></a>
								</div>
							</div>
						</div>
					</div>
        						    ...
        						    <div class="legend">
            							<div class="box">
            								...
            								<div class="row">
            									...
            									<div class="col-6">
            										<ul>
            											<li><b>SW</b> = SIDEWALL</li>
            											<li><b>OWL</b> = OUTLINE WHITE LETTERS</li>
            										</ul>
            									</div>
            								</div>
            							</div>
				...
				<div id="section-contact" class="section center notopmargin nobottommargin pt-lg pb-lg">
					<div class="container clearfix">
						<div class="heading-block  center custom-heading-block2">
