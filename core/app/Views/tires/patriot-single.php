...
<section id="content">
	...
	<div class="content-wrap product-single">
          ...
          <div class="col-lg-12">
             <ol class="breadcrumb product-breadcrumb">
              ...
              <li class="breadcrumb-item"><i class="icon-angle-right"></i><?= htmlspecialchars_decode($tyres['title']); ?></li>
				...
				<div class="row clearfix product-details vertical-align details-again ">
					<div class="col-lg-6 vcenter">
						<h2 class="product-title ColorGreen"><?= htmlspecialchars_decode($tyres['title']); ?></h2>
						<?php 
                			$pmeta=array();
              ...
              <div class="flexslider" id="slider-flex2">
                <div class="slider-wrap">
                  <?php foreach ($images as $image) { ?>
                      <div class="slide"><img class="lozad" data-src="<?= base_url('storage/tire_images/other/'.$image);?>" alt="<?= $tyres['title']; ?>"></div>
                  <?php } ?>
                </div>
              </div>
            </div>
		...
		<section id="full-width" class="full-section product-features  product-features2  clearfix" style="background-color: #f7f7f7;">
            ...
            <div class="oc-item">
              <div class="ipost clearfix">
                ...
                <div class="products-image lozad-background" data-background-image="<?= base_url('storage/features/'.$feature['image']);?>" ><!--<img src="<?= base_url('storage/features/'.$feature['image']);?>" alt="">--></div>
              </div>
            </div>
            <?php } ?>
          </div>
    ...
    <section id="full-width" class="full-section product-sizes clearfix">
			...
			<div class="container clearfix">
              ...
              <?= ($extra_cols_on && count($extra_cols)===1)?'four-cols':'';?>">
        ...
        <div class="row clearfix product-sizes-buttons 
              ...
              <?= ($extra_cols_on && count($extra_cols)===1)?'four-cols':'';?>">
					<div class="col-md-3">
					<a href="#" class="greenbutton printbutton">Print</a>
					</div>
					<div class="col-md-9 "></div>
          <!-- <div class="col-md-12">
                <span class="meaning"><strong>L.I.</strong> = Load Index, <strong>S.R.</strong> = Speed Rating, <strong>L.R.</strong> = Load Range, <i class="omniicon-cloud-rain"></i> = Wet Grip, <i class="omniicon-fuel"></i> = Fuel Efficiency, <i class="omniicon-volume"></i> = External Rolling Noise, &nbsp; = Noise Level in Decibels, <strong>POR</strong> = Professional Off-Road tire. Learn more about the EU grades <a class="ColorBlue" href="<?= base_url('european-tyre-labeling'); ?>">here</a>. 
                  <br>
                  <strong>Speed Rating:</strong> <strong>K</strong> = 110 km/h or 68 mph, <strong>Q</strong> = 160 km/h or 100 mph.  | <strong>Load Range:</strong> <strong>XL</strong> = Extra Load, <strong>D</strong> = 8-ply rating, <strong>E</strong> = 10 10-ply rating, <strong>F</strong> = 12-ply rating
              ...
              <div class="col-md-12">
                <span class="meaning">
                  ...
                  <?php } else{ ?>
                    ...
                    <strong>L.I.</strong> = Load Index, <strong>S.R.</strong> = Speed Rating, <strong>L.R.</strong> = Load Range 
                    ...
                    .
                    <br>
                    <strong>Speed Rating: H</strong> = 210 km/h or 130 mph, <strong>V</strong> = 240 km/h or 149 mph, <strong>W</strong> = 270 km/h or 168 mph. | <strong>Load Range: XL</strong> = Extra Load
