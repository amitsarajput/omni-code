	...
	<div class="slider-parallax-inner">
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide dark lozad-background" data-background-image="<?= base_url('assets/img/radar-us-banner-premium-collection.webp') ?>" >
			    ...
			    <a href="<?= base_url('radar-us/us-all-season-ev'); ?>" class="swiper-slide  dark lozad-background" data-background-image="<?= base_url('assets/img/radar-us-banner-all-season-ev.webp') ?>">
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center">
							<h2>&nbsp;</h2>
							<p class="">&nbsp;</p>
						...
						<div class="container clearfix">
								...
								<?php $i=1; foreach ($car_cuv_suv as $tyre) { ?>
									<div class="col-md-6">
										<div class="brand-product-item center <?= $tyre['premium_tyre']!==null ?'premium-tyre':'' ?>">
											<h2 class="product-title"><a class="ColorRed" href="<?php echo base_url($brand_slug.$tyre['slug']); ?>"><?= htmlspecialchars_decode($tyre['title']); ?></a></h2>
											<?php
    										$pmeta=array();
							...
							<div class="tab-content clearfix" id="tabs-suvlighttruck">
								...
								<?php $i=1; foreach ($suv_light_truck as $tyre) {   
								        if($tyre['slug']==='us-renegade-x'){
								            $brand_slug='radar-us/';}
								        else{$brand_slug='radar-us-staging/';}
								?>
										<div class="col-md-6">
										<div class="brand-product-item center  <?= $tyre['premium_tyre']!==null ?'premium-tyre':'' ?>">
											<h2 class="product-title"><a class="ColorRed" href="<?= ($tyre['external_link']===null || $tyre['external_link']==="")?base_url($brand_slug.$tyre['slug']):base_url($tyre['external_link']); ?>"><?= htmlspecialchars_decode($tyre['title']); ?></a></h2>
										<?php
    										$pmeta=array();
    										if($tyre['category']) {array_push($pmeta, $tyre['tc_title']);}
    										if($tyre['terrain_category']){
											...
											<div class="product-image">
												<a href="<?= ($tyre['external_link']===null || $tyre['external_link']==="")?base_url($brand_slug.$tyre['slug']):base_url($tyre['external_link']); ?>">
													<?php $tyre_image=json_decode( $tyre['image'], $assoc_array = true ) ?>
													<img 
													data-src="<?= base_url('storage/tire_images/'.$tyre_image['featured']); ?>" 
													alt="Radar Tire" 
