                            ...
                            <td colspan="4">
                              ...
                              <div class="eulabeldetails-wrapper">
                                ...
                                <div class="eulabel-image <?= $exempted?'no-border':'';?>">
                                  <img class="lozad" data-src="<?= base_url('storage/eu-labels/Label_'.$eulabel.'.webp') ?>" alt="">
                                </div>
                              </div>
                              <?php else:?>
                              <div class="eulabeldetails-wrapper">
                ...
                <span class="meaning">
                  ...
                  <?php } else{ ?>
                    ...
                    <?php if ($extra_cols_on==true): ?>
                      ...
                      <?php endif; ?>
                    <?php endif; ?>
                    .<br class="hidden-xs"> Learn more about the EU grades <a class="blue" href="<?= base_url('european-tyre-labeling'); ?>">here</a>. 
                    <br>
                    <strong>Speed Rating:</strong> <strong>V</strong> = 240 km/h, <strong>W</strong> = 270 km/h, <strong>Y</strong> = 300 km/h | <strong>Load Range:</strong>  <strong>XL</strong> = Extra Load, <strong>RFT</strong> = Run-Flat.  
