		...
		<section id="full-width" class="full-section product-features  product-features2  clearfix" style="background-color: #f7f7f7;">
            ...
            <div class="oc-item">
              <div class="ipost clearfix">
               ...
               <div class="products-image lozad-background" dta-background-image="<?= base_url('storage/features/'.$feature['image']);?>" ><img class="lozad" data-src="<?= base_url('storage/features/'.$feature['image']);?>" alt=""></div>
              </div>
            </div>
            <?php } ?>
          </div>
