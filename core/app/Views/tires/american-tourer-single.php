              ...
              <li class="breadcrumb-item"><i class="icon-angle-right"></i><?= htmlspecialchars_decode($tyres['title']); ?></li>
				...
				<div class="row clearfix product-details vertical-align details-again ">
					<div class="col-lg-6 vcenter">
						<h2 class="product-title ColorBlue"><?= htmlspecialchars_decode($tyres['title']); ?></h2>
						<?php 
                			$pmeta=array();
            ...
            <span  class="meaning">
                ...
                <?php } else{ ?>
                  ...
                  <strong>L.I.</strong> = Load Index, <strong>S.R.</strong> = Speed Rating, <strong>L.R.</strong> = Load Range 
                    ...
                    .
                    <br>
                  <strong>Speed Rating:</strong> <strong>H</strong> = 210 km/h or 130 mph, <strong>V</strong> = 240 km/h or 149 mph, <strong>W</strong> = 270 km/h or 168 mph. | <strong>Load Range: XL</strong> = Extra Load
