	...
	<div class="slider-parallax-inner">
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				<div class="swiper-slide dark lozad-background" data-background-image="<?= base_url('assets/img/agora-brand-banner.webp');?>">
					<div class="container clearfix">
						<div class="slider-caption slider-caption-center custom-slider">
							<h2 data-animate="fadeInUp"><img class="lozad" data-src="<?= base_url('assets/img/agora-banner-title.webp');?>" alt="" width="500"></h2>
						</div>
					</div>
				</div>
					...
					<div class="product-cat-nav product-cat-nav2 hidden">
						<div class="container clearfix">
							<ul class="tab-nav tab-nav2 brand-tabs BlueSec american-fillter center clearfix">
								...
								<li><a href="#tabs-van"><i class="omniicon-light-truck-2"></i>VAN</a></li>
							</ul>
						</div>
					</div>
								...
								<?php $i=1; foreach ($car_suv as $tyre) { ?>
									<div class="col-md-6">
										<div class="brand-product-item center">
											<h2 class="product-title"><a class="ColorBlack" href="<?= base_url('agora/'.$tyre['slug']); ?>"><?= htmlspecialchars_decode($tyre['title']); ?></a></h2>
											<?php 
    										$pmeta=array();
											...
											<div class="product-image">
												<a href="<?= base_url('agora/'.$tyre['slug']); ?>">
			...
			<div class="container limilt-section bottommargin-sm">
				<div class="row clearfix center">
					<div class="col-lg-12">
						...
						<p class="center">
							All Agora tyres come with a Limited Warranty.<br> For details <a class="red" href="<?= base_url('limited-warranty-agora'); ?>">click here</a>.
						</p>
