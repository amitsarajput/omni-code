              ...
              <li class="breadcrumb-item"><i class="icon-angle-right"></i><?= htmlspecialchars_decode($tyres['title']); ?></li>
				...
				<div class="row clearfix product-details vertical-align details-again ">
					<div class="col-lg-6 vcenter">
						<h2 class="product-title ColorBlack"><?= htmlspecialchars_decode($tyres['title']); ?></h2>
						<?php 
                			$pmeta=array();
		...
		<section id="full-width" class="full-section product-features  product-features2  clearfix" style="background-color: #f7f7f7;">
            ...
            <div class="oc-item">
              <div class="ipost clearfix">
               ...
               <div class="products-image lozad-background" data-background-image="<?= base_url('uploads/features/'.$feature['image']);?>" ><img class="lozad" data-src="<?= base_url('uploads/features/'.$feature['image']);?>" alt=""></div>
              </div>
            </div>
            <?php } ?>
          </div>
...
<style>
  ...
  @media only screen and (max-width: 540px) {
      .product-features .product-feature-points .owl-item .oc-item .products-image{min-height:353px;}
  }
