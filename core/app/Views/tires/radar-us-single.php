...
<section id="content">
  ...
  <div class="content-wrap product-single radar-tires">
   ...
   ?>
    ...
    <!--Video Reviews-->
    <?php if($tyre_reviews!=null): 
        //$video_reviews=explode(',', $tyre_reviews['video_reviews']);
        $video_reviews=json_decode($tyre_reviews['video_reviews'],true);
        //print_r($video_reviews);
            ...
            <div class="row">
                <div class="vid-reviews"  data-lightbox="gallery">
                    <?php foreach($video_reviews as $review): if($review['poster']==null){$review['poster']='noimage.webp';}?>
                        <a class="vid-review lozad-background mfp-iframe" href="<?php echo $review['url']; ?>" data-lightbox="gallery-item"  data-background-image="<?= base_url('storage/video-reviews-posters/'.$review['poster']);?>"></a>
                        <!-- Modal -->
                		<div class="modal1 mfp-hide" id="myModal<?= $i; ?>">
                		    ...
                		    <button title="Close (Esc)" type="button" class="mfp-close">×</button>
                				...
                				<div class="center clearfix" style="padding: 10px;">
                				    <!--<iframe width="720" height="450" src="<?php echo $review['url']; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>-->
                					<!--<p class="lead nobottommargin topmargin-sm"><?php echo $review['url']; ?></p>-->
                				</div>
                				<div class="navigation left"><i class="icon-angle-left"></i></div>
                				<div class="navigation right"><i class="icon-angle-right"></i></div>
                			</div>
                		</div>
                    <?php $i++; endforeach; ?>
                </div>
