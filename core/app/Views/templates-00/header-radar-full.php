			...
			<div id="header-wrap">
				<div class="container clearfix">
					...
					<div id="logo" class="custom-logo">
						<a href="<?= base_url("radar-us") ?>" class="standard-logo main-logo"><img src="<?= base_url('assets/img/logos/header-logos/radar-logo-white.png');?>"  alt="Omni"></a>
						<a href="<?= base_url("radar-us") ?>" class="retina-logo" data-dark-logo="<?= base_url('assets/img/logos/header-logos/radar-logo-white.png');?>"><img src="<?= base_url('assets/img/logos/header-logos/radar-logo-white.png');?>" alt="Omni"></a>
					</div><!-- #logo end -->
