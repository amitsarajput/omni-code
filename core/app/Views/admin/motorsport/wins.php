		...
		<section id="full-width" class="bottommargin topmargin">
			...
			<div class="container clearfix">
				...
				<div class="heading-block  center custom-heading-block about-heading">
					<h2  class="pbxs">Race Win</h2>
				</div>

				<div class="row clearfix">
					<div class="col_full">

							<p><a href="<?= base_url('admin/win/add')?>" class="button button-border button-rounded button-green"><i class="icon-plus"></i>Add New</a></p>
						<?php if($records){ ?>
								...
								<table class="dataTable table table-striped table-bordered" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr id="<?= $record['id']; ?>">
											...
											<td><?= $post['date']; ?></td>
											<td>
												<a href="<?= base_url('admin/win/edit/'.$record['id']); ?>" class="button button-mini button-circle button-blue" >Edit</a>
