		...
		<section id="full-width" class="bottommargin topmargin">
			...
			<div class="container clearfix">
				...
				<div class="heading-block  center custom-heading-block about-heading">
					<h2  class="pbxs">All Contact Inquiry</h2>
				</div>
									...
									<tbody>
										...
										<tr id="<?= $record['id']; ?>">
											...
											<td>
												...
												<a href="#" data-type="submisson" data-action="del" data-id="<?= $record['id']; ?>" data-url="<?= base_url('admin/contactinquiry-delete'); ?>" class="button button-mini button-circle button-red item_delete" >Delete</a>
											</td>
										</tr>
										<?php $i++; } ?>			
									</tbody>
